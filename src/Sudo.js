...
module.exports = async (options) => {
	...
	if (typeof options.member !== 'object') throw new TypeError('Sudo Error: Invalid Discord GuildMember was provided.',);

	if (!options.text) throw new Error('Sudo Error: text argument was not specified.');
	if (typeof options.text !== 'string') throw new TypeError('Sudo Error: text must be a string.');
	...
	if (typeof options.deleteMessage !== 'boolean') throw new TypeError('Sudo Error: deleteMessage must be a boolean.');
